...
(def allowed-deps
  '{clj-mutate.digest #{}
    ...
    clj-mutate.project #{clj-mutate.digest}
    clj-mutate.lcov #{}
    clj-mutate.backup #{}
    clj-mutate.report #{}
...
(def far-from-io
  '#{clj-mutate.digest clj-mutate.syntax clj-mutate.mutations clj-mutate.lcov
     clj-mutate.manifest clj-mutate.source clj-mutate.selection clj-mutate.report})
